          ...
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div className="emergency-contents">
                ...
                <h2>
                  How Can I get best to <br /> protect myself
                </h2>
                <p>
                ...
                <ul>
                  <li>
                    Wash your hands often with soap and water for at least 15-20
                    seconds.
                  </li>
                  <li>
                  ...
                  <li>
                    Avoid close contact (within 6 feet) with people who are
                    sick.
                  </li>
