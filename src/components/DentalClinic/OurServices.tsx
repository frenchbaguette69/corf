          ...
          <div className="row">
            <div className="col-lg-4 col-sm-6">
              <div className="single-services">
                <span>
                  <Image
                    src="/img/home-eight/service-icon1.png"
                    alt="Image"
                    width={512}
                    height={512}
                  />
            ...
            <div className="col-lg-4 col-sm-6">
              <div className="single-services">
                <span>
                  <Image
                    src="/img/home-eight/service-icon2.png"
                    alt="Image"
                    width={512}
                    height={512}
                  />
            ...
            <div className="col-lg-4 col-sm-6">
              <div className="single-services">
                <span>
                  <Image
                    src="/img/home-eight/service-icon3.png"
                    alt="Image"
                    width={512}
                    height={512}
                  />
            ...
            <div className="col-lg-4 col-sm-6">
              <div className="single-services">
                <span>
                  <Image
                    src="/img/home-eight/service-icon4.png"
                    alt="Image"
                    width={512}
                    height={512}
                  />
            ...
            <div className="col-lg-4 col-sm-6">
              <div className="single-services">
                <span>
                  <Image
                    src="/img/home-eight/service-icon5.png"
                    alt="Image"
                    width={512}
                    height={512}
                  />
            ...
            <div className="col-lg-4 col-sm-6">
              <div className="single-services">
                <span>
                  <Image
                    src="/img/home-eight/service-icon6.png"
                    alt="Image"
                    width={512}
                    height={512}
                  />
